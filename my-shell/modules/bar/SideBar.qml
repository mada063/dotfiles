...
PanelWindow {
    ...
    property date sideClockNow: new Date()
    readonly property string dateText: Qt.formatDateTime(sideClockNow, "HH\n-\nmm\n-\nss")
    ...
    Timer {
        ...
        repeat: true
        onTriggered: root.sideClockNow = new Date()
    }
